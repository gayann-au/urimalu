...
// This page is English only, always, while the rest of the app stays bilingual.
// getFixedT returns a translator pinned to English that ignores i18n.language,
// so no saved preference, browser locale, or detector can flip this page. It is
// a read of the resource store and nothing else: it does not call
// changeLanguage, so visiting here cannot disturb the language the user chose
// for the app inside. The Kannada landing keys stay in kn.json, unused for now,
// until a native speaker verifies them.
